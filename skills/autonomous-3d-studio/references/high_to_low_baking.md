...
For enterprise-scale studio pipelines, the skill orchestrates Adobe Substance Automation Toolkit (SAT) command-line tools via [`scripts/substance_sat_baker.py`](file:///root/.gemini/config/skills/autonomous-3d-studio/scripts/substance_sat_baker.py):
