...
| :--- | :--- | :--- |
| [`scripts/audiogram_generator.py`](file://~/.ciel/skills/procedural-audio/scripts/audiogram_generator.py) | Python (NumPy, SciPy, Matplotlib) | Generates high-contrast 300 DPI composite Audiogram PNGs for multimodal Vision LLMs. |
| [`scripts/audio_manifest_extractor.py`](file://~/.ciel/skills/procedural-audio/scripts/audio_manifest_extractor.py) | Pure Python Standard Library | Zero-dependency extractor converting any `.wav` into the full 3-Tier JSON manifest for text LLMs. |
