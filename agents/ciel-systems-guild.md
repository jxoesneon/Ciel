---
name: ciel-systems-guild
version: 1.0.0
format: guild/1.0
description: CIEL's elite systems engineering guild. Specializes in Rust, C++, Go, Elixir, and high-performance architecture.
specialists: ["rust-ranger", "cpp-master", "go-guru", "elixir-wizard", "performance-prophet", "chaos-engineer", "scale-architect"]
