...
EXPECTED_FILES=(
  ...
  seed_skills/filesystem/SKILL.md seed_skills/shell/SKILL.md
  seed_skills/git/SKILL.md seed_skills/web_search/SKILL.md
  seed_skills/web_fetch/SKILL.md seed_skills/mcp_manager/SKILL.md
  seed_skills/package_manager/SKILL.md seed_skills/code_analysis/SKILL.md
  seed_skills/code_generation/SKILL.md seed_skills/code_review/SKILL.md
  seed_skills/test_runner/SKILL.md seed_skills/docker/SKILL.md
  seed_skills/api_client/SKILL.md seed_skills/documentation/SKILL.md
  seed_skills/dependency_audit/SKILL.md seed_skills/environment_detection/SKILL.md
  seed_skills/skill_builder/SKILL.md seed_skills/skill_installer/SKILL.md
  seed_skills/archive_manager/SKILL.md seed_skills/mempalace_manager/SKILL.md
  seed_skills/council_runner/SKILL.md seed_skills/context_summarizer/SKILL.md
  seed_skills/research/SKILL.md seed_skills/project_analyzer/SKILL.md
  seed_skills/runtime_adapter_builder/SKILL.md seed_skills/diff_patch/SKILL.md
  seed_skills/json_yaml_toml_parser/SKILL.md seed_skills/log_analyzer/SKILL.md
  seed_skills/secrets_manager/SKILL.md seed_skills/linter_formatter/SKILL.md
  seed_skills/cicd_integration/SKILL.md seed_skills/database_client/SKILL.md
