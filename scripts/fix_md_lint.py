...
agents_dir = r'~\Ciel\agents'
files_to_fix = [os.path.join(agents_dir, f) for f in os.listdir(agents_dir) if f.endswith('.md')]
files_to_fix.append(r'~\Ciel\README.md')
files_to_fix.append(r'~\Ciel\ciel.skill\SKILL.md')
files_to_fix.append(r'~\Ciel\ciel.skill\MANIFEST.md')
files_to_fix.append(r'~\Ciel\ciel.skill\CHANGELOG.md')
